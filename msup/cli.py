...
def _add_args(
    ...
    for field_index, f in enumerate(command_fields):
        ...
        default_value = f.default if f.default is not MISSING and (not force_no_default or annotation is bool) else None
        ...
        if env_value is not None:
            default_value = _from_value(env_value, annotation, str, name)
        ...
        if is_dataclass(effective_type):
            ...
            _add_args(parser, effective_type, prefix=name, short_prefix=child_short, force_no_default=True)
    ...
    for f in fields(clazz):
        ...
        if is_dataclass(effective_type):
            ...
            if value is MISSING or value is None:
                ...
                converted = _from_value(value, effective_type, type(value), name)
