...
from msup.base import from_dict, from_json, to_dict, to_json, to_kwargs
...
class PydanticSerializationTests(unittest.TestCase):
    ...
    def test_nested_models_accept_instances_dicts_json_and_json_paths(self):
        common = {
            "required": 3,
            "mapping": {},
            "positive": 1,
        ...
        with TemporaryDirectory() as directory:
            ...
            path.write_text('{"name": "nested", "count": "7"}')
